...
* checked_out_items - a collection of LibraryItems that a Patron currently has checked out (you choose both the type of collection and whether to store LibraryItem IDs or LibraryItem objects)
...
* holdings - a collection of the LibraryItems that belong to the Library (you choose both the type of collection and whether to store LibraryItem IDs or LibraryItem objects)
* members - a collection of the Patrons who are members of the Library (you choose both the type of collection and whether to store Patron IDs or Patron objects)
